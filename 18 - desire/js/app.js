...
if (document.querySelector('.pagination-fill')) {
	...
	function createPagination(totalPages, page) {
		...
		if (page > 1) { //show the next button if the page value is greater than 1
			liTag += `<li class="pagination-fill__prev _icon-arrow-prev" onclick="createPagination(totalPages, ${page - 1})"></li>`;
		}

		if (page > 2) { //if page value is less than 2 then add 1 after the previous button
			liTag += `<li class="pagination-fill__number pagination-fill__number_first" onclick="createPagination(totalPages, 1)"><span>1</span></li>`;
		...
		for (var plength = beforePage; plength <= afterPage; plength++) {
			...
			liTag += `<li class="pagination-fill__number ${active}" onclick="createPagination(totalPages, ${plength})"><span>${plength}</span></li>`;
		}
		...
		if (page < totalPages - 1) { //if page value is less than totalPage value by -1 then show the last li or page
			...
			liTag += `<li class="pagination-fill__number pagination-fill__number_last" onclick="createPagination(totalPages, ${totalPages})"><span>${totalPages}</span></li>`;
		}

		if (page < totalPages) { //show the next button if the page value is less than totalPage(20)
			liTag += `<li class="pagination-fill__next _icon-arrow-next" onclick="createPagination(totalPages, ${page + 1})"></li>`;
		}
...
function mapAdd() {
	...
	tag.src = "https://maps.google.com/maps/api/js?sensor=false&amp;key=AIzaSyA3wujX-eF3DuGRSWxbEirLbwjD4QNWUXs&callback=mapInit";
