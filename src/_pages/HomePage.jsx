            ...
            <section className="page__collection collection">
                <div className="collection__top top-collection">
                    <div className="top-collection__container _container">
                        ...
                        <div className="top-collection__text">
                ...
                <div className="collection__body body-collection">
                    <div className="body-collection__column">
                        ...
                        <div className="body-collection__image _ibg">
                            <img src="img/_home/content/01.jpg" alt="" />
                        </div>
                    </div>
                    <div className="body-collection__column">
                        <div className="body-collection__info">
                        ...
                        <div className="body-collection__image _ibg">
                            <img src="img/_home/content/02.jpg" alt="" />
                        </div>
                    </div>
                    <div className="body-collection__column">
                        <div className="body-collection__info">
                        ...
                        <div className="body-collection__image _ibg">
                            <img src="img/_home/content/03.jpg" alt="" />
                        </div>
                    </div>
                    <div className="body-collection__column">
                        <div className="body-collection__info">
                        ...
                        <div className="body-collection__image _ibg">
                            <img src="img/_home/content/04.jpg" alt="" />
                        </div>
                    </div>
                    <div className="body-collection__column">
                        <div className="body-collection__info">
                        ...
                        <div className="body-collection__image _ibg">
                            <img src="img/_home/content/05.jpg" alt="" />
                        </div>
                    </div>
                </div>
                <div className="collection__bottom bottom-collection">
                    <div className="bottom-collection__info">
                        <div className="bottom-collection__container _container">
                            <div className="bottom-collection__content">
                                <h2 className="bottom-collection__title">
                                    Aesthetic <br />
                                    ethical drinking
                                </h2>
                        ...
                        <div className="bottom-collection__image _ibg">
                            <img src="img/_home/content/06.jpg" alt="" />
                        </div>
                    </div>
                </div>
            </section>
